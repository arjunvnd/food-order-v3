...
export default function VendorDineInPage() {
  ...
  useEffect(() => {
    if (!vendorId || !tableId) return;

    dispatch(setVendorTableContext({ vendorId, tableId }));
